...
Feature: Placeholder - Recursos
    ...
    @regressivo @recursos
    Scenario: Buscar recurso por ID - valido
        Given fizer consulta de recurso por tipo 'valido'
        When deve validar o status code 200 e schema 'get_recurso' com sucesso
        Then sera retornado consulta do recurso com sucesso

    # @regressivo @recursos
    # Scenario: Buscar recurso por ID - invalido
    #     Given fizer consulta de recurso por tipo 'invalido'
    #     Then deve validar o response e o status code 404

    # @regressivo @recursos
    # Scenario: Buscar recurso por ID - null
    #     Given fizer consulta de recurso por tipo 'null'
    #     Then deve validar o response e o status code 404
